...
# MySQL connection
# Change 'mysql://' to 'mysql+aiomysql://'
MYSQL_URL = os.environ.get('MYSQL_URL', 'mysql+aiomysql://4EQYUkSgFFfYG8z.root:gVhGvvHTHMDmJ1Jp@gateway01.eu-central-1.prod.aws.tidbcloud.com:4000/buscare')

# Change 'mysql://' to 'mysql+pymysql://'
MYSQL_URL_SYNC = os.environ.get('MYSQL_URL_SYNC', 'mysql+pymysql://4EQYUkSgFFfYG8z.root:gVhGvvHTHMDmJ1Jp@gateway01.eu-central-1.prod.aws.tidbcloud.com:4000/buscare')
